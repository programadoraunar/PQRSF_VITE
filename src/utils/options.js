/**
 * @file options.js
 * @description Este archivo contiene las opciones utilizadas en varios componentes de la aplicación,
 * como las dependencias, los canales y los tipos de solicitud.
 *
 */

/**
 * @constant {Array<string>} optionsDependencias
